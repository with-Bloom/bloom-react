    ...
    <div className="px-6">
      ...
      <div className="flex flex-col gap-1.5">
        <div className="mt-[36px] flex items-center justify-between">
          <span className=" font-pretendard text-[22px] font-bold tracking-[-0.5px] text-gray1000">
            {TITLE}
          </span>
          <BeatLoader color="#606873" size={9} />
        </div>
        <span className="block font-pretendard tracking-[-0.4px] text-gray800">{SUB_TITLE}</span>
      </div>
      {isRenew ? (
        ...
        <div className="mt-6 flex h-[185px] w-full justify-between rounded-xl bg-gray100 pl-4 pt-[30px] tracking-[-0.6px]">
          <span className="font-pretendard whitespace-pre-line text-[15px] leading-[165%] text-gray800">
            {randomCaution}
          </span>
          <LoadingAvatar />
        </div>
